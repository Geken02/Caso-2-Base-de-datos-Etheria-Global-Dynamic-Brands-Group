...
CREATE TABLE ResumenResenasProductos (
    resumenResenaProductoId INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE DistribucionResenasProductos (
    distribucionId INT AUTO_INCREMENT PRIMARY KEY,
    resumenResenaProductoId INT NOT NULL REFERENCES ResumenResenasProductos(resumenResenaProductoId),
    ...
    ultimaAuditoria TIMESTAMP,
    activo BOOLEAN DEFAULT TRUE,
    CONSTRAINT uk_dist_resumen_valor UNIQUE (resumenResenaProductoId, valorCalificacion)
);
